<script lang="ts">
	...
	import ModelInfoManager from '$lib/components/admin/ModelInfoManager.svelte';
	...
	// Tab for model list or model info
	let activeTab = 'models'; // 'models' or 'model-info'
...
{#if models !== null}
	{#if selectedModelId === null}
		...
		<div class="flex border-b border-gray-200 dark:border-gray-700 mb-4">
			<button
				class="px-4 py-2 font-medium {activeTab === 'models' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}"
				on:click={() => activeTab = 'models'}
			>
				{$i18n.t('Models')}
			</button>
			<button
				class="px-4 py-2 font-medium {activeTab === 'model-info' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}"
				on:click={() => activeTab = 'model-info'}
			>
